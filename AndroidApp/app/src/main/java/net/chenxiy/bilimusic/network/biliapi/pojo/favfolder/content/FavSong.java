...
@Entity(tableName = "favSong",indices = {@Index(value = {"fid"})},foreignKeys = @ForeignKey(entity = FavFolderContentData.class,parentColumns = "fid",childColumns = "fid",onDelete = ForeignKey.CASCADE))
